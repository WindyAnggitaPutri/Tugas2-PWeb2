...
<h2>Daftar Mahasiswa Yang Berasal Dari Cilacap</h2><!--Perintah untuk membuat judul di halaman-->
<p>Daftar Mahasiswa D3 Teknik Informatika Yang Berasal Dari Cilacap</p><!--Perintah untuk memberikan penjelasan berupa teks-->
      ...
      <thead>
        ...
        <tbody>
          <?php
            ...
            $wilayah = new Wilayah(); //membuat objek baru dari class wilayah
            $query = $wilayah->tampilData(); //mengambil data dari database 
