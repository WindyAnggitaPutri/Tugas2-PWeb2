...
<h2>Daftar Mahasiswa Yang Menerima Beasiswa</h2><!--Perintah untuk membuat judul di halaman-->
<p>Daftar Mahasiswa Yang Mendapat Beasiswa Sesuai dengan Nilai Akhir</p> <!--Perintah untuk memberikan penjelasan berupa teks-->
  ...
  <table class="table table-bordered" id="myTable">
    <thead>
      <tr>
        ...
        <th scope="col">ID MAHASISWA</th><!--Perintah untuk membuat kolom mahasiswa-->
    ...
    <tbody>   
      <?php
          ...
          $beasiswa = new Beasiswa();//membuat objek baru dari class beasiswa
          $query = $beasiswa->tampilData(); //mengambil data dari database 
      ...
      <tr>
        ...
        <td><?php echo $row['semester_id'] ?></td><!--perintah untuk menampilkan semester_id-->
      </tr>
