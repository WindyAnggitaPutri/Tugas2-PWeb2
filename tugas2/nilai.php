...
<h2>Daftar Nilai Mahasiswa</h2><!--Perintah untuk membuat judul di halaman-->
<p>Daftar Nilai Mahasiswa D3 Teknik Informatika Setelah UAS</p><!--Perintah untuk memberikan penjelasan berupa teks-->             
  <div class="card-body">
      ...
      <tr>
        ...
        <tbody>
           <?php 
              ...
              $query = $connection->query("SELECT * FROM tbl_nilai");
